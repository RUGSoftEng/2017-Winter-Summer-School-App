const modalSelector = "#add-lecturer ";
const titleSelector = "#lecturerTitle";
const descriptionSelector = "#lecturerDescription";
...
$(function () {
	...
	$(".edit").click(function () {
		const editTitleValue = $("#add-lecturer .modal-title").text();
		const editTextValue = $("#modalDescription").html();
		const editWebsiteValue = $("#modalWebsite").html();
		const editImgValue = $("#add-lecturer #modal-thumbnail").attr("src");
		addNewItem(true);
		$("#add-lecturer form").attr("action", "API/lecturer");
